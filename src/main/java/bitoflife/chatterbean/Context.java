...
/**
A conversational context. This class stores information such as the history of a conversation and predicate values, which the Alice BotFactory can refer to while responding user requests.
*/
